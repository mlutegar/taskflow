...
export default function NapSession({ preset, onClose, onComplete }: NapSessionProps): JSX.Element {
  const duration = preset?.duration ?? 5; // minutos
  const totalSeconds = duration * 60;

  const [phase, setPhase] = useState<Phase>("idle"); // idle | running | done
