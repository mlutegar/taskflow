...
interface SubtaskFlowProps {
  checklist: ChecklistItem[];
  onToggle: (itemId: string | number) => void | Promise<void>;
  onAllDone: () => void;
  onSkip?: () => void;
}

export default function SubtaskFlow({ checklist, onToggle, onAllDone, onSkip }: SubtaskFlowProps): JSX.Element {
