...
function getMotivation(minutes: number): string {
...
export default function SessionSummary({ mode, durationMinutes, tasksCompleted, onClose, onContinue }: SessionSummaryProps): JSX.Element {
  return (
