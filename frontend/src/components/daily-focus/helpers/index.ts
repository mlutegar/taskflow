...
export const HELPER_REGISTRY: Record<string, HelperEntry> = {
  ...
  tiktok_fixed:       { Component: TikTokHelper, defaultState: { ...tiktokDefault, platform: "tiktok", variant: "fixed" } },
  tiktok_prog_videos: { Component: TikTokHelper, defaultState: { ...tiktokDefault, platform: "tiktok", variant: "prog_videos" } },
  tiktok_prog_both:   { Component: TikTokHelper, defaultState: { ...tiktokDefault, platform: "tiktok", variant: "prog_both" } },
  reels_fixed:        { Component: TikTokHelper, defaultState: { ...tiktokDefault, platform: "reels",  variant: "fixed" } },
  reels_prog_videos:  { Component: TikTokHelper, defaultState: { ...tiktokDefault, platform: "reels",  variant: "prog_videos" } },
  reels_prog_both:    { Component: TikTokHelper, defaultState: { ...tiktokDefault, platform: "reels",  variant: "prog_both" } },
  tiktok_detox:       { Component: TikTokHelper, defaultState: { ...tiktokDefault, platform: "tiktok", variant: "detox" } },
  reels_detox:        { Component: TikTokHelper, defaultState: { ...tiktokDefault, platform: "reels",  variant: "detox" } },
 ...
 */
export function getHelper(modeId: string | null | undefined): HelperEntry | null {
