...
interface TabModeBarTask {
  title?: string;
  done?: boolean;
}

interface TabModeBarProps {
  tasks: TabModeBarTask[];
  currentIdx: number;
...
function TabModeBar({ tasks, currentIdx, onSwitch, onNextTab, onAddTab, cycleCount, elapsedSecs }: TabModeBarProps): JSX.Element {
