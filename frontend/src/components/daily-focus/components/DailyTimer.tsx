...
function DailyTimer({ totalSeconds, initialRemaining, running, onTick, onComplete }: DailyTimerProps) {
  const [remaining, setRemaining] = useState<number>(initialRemaining ?? totalSeconds);
